...
print('[ atoms ]')
local map = {CG1='SP6',CG2='SP6',CG3='TC1',CG4='SP6'}
local count = 0
for k=1,#system do
    local res = system[k]
    local resid,resname,chain = res.resid,res.resname,res.chain
...
for s=0,natoms,4 do
    ...
    printbonds(s+1,s+4,0.642,2500.0) -- O2O6 | 6.502024 0.173141 5.338142 6.969646 | 6.431115 0.212127 5.286103 6.990696 | 6.347560 0.125028 5.356040 6.942769
    printbonds(s+2,s+4,0.576,2500.0) -- O3O6 | 5.611158 0.294130 4.685321 6.507639 | 5.596012 0.328396 4.595749 6.505277 | 6.075645 0.223052 4.630463 6.502710
